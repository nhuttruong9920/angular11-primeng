...
!(function () {
  ...
  function jt(t) {
    ...
    m && (y.attributes[Z] = ''),
      s && y.children.push({ tag: 'title', attributes: { id: y.attributes['aria-labelledby'] || 'title-'.concat(f || kt()) }, children: [s] });
    var w,
      x,
      k,
      A,
      ...
      X,
      B,
      V = Q({}, y, { prefix: r, iconName: i, main: n, mask: a, maskId: l, transform: o, symbol: c, styles: u.styles }),
      K =
        a.found && n.found
          ? ((k = (w = V).children),
            (A = w.attributes),
            ...
            (I = { tag: 'g', attributes: Q({}, j.inner), children: [Et(Q({ tag: M.tag, attributes: Q({}, M.attributes, j.path) }, R))] }),
            (_ = { tag: 'g', attributes: Q({}, j.outer), children: [I] }),
            (T = 'mask-'.concat(S || kt())),
            (Y = 'clip-'.concat(S || kt())),
            (F = {
              tag: 'mask',
              attributes: Q({}, zt, { id: T, maskUnits: 'userSpaceOnUse', maskContentUnits: 'userSpaceOnUse' }),
              children: [L, _],
            }),
            (H = { tag: 'defs', children: [{ tag: 'clipPath', attributes: { id: Y }, children: ((x = E), 'g' === x.tag ? x.children : [x]) }, F] }),
            k.push(H, {
              tag: 'rect',
              attributes: Q({ fill: 'currentColor', 'clip-path': 'url(#'.concat(Y, ')'), mask: 'url(#'.concat(T, ')') }, zt),
            }),
                  ...
                  children: [
                    {
                      ...
                      children: [{ tag: a.icon.tag, children: a.icon.children, attributes: Q({}, a.icon.attributes, o.path) }],
                    },
                  ],
                });
              } else e.push(a.icon);
          ...
          [
            {
              ...
              children: [
                { tag: 'symbol', attributes: Q({}, X, { id: !0 === B ? ''.concat(U, '-').concat($.familyPrefix, '-').concat(W) : B }), children: q },
              ],
            },
          ])
        : (function (t) {
  ...
  var ee = {
    replace: function (t) {
      ...
      if (e.parentNode && e.outerHTML)
        e.outerHTML = n + ($.keepOriginalSource && 'svg' !== e.tagName.toLowerCase() ? '\x3c!-- '.concat(e.outerHTML, ' --\x3e') : '');
      ...
      (oe = new l(function (t) {
        re ||
          At(t).forEach(function (t) {
            if (
              ('childList' === t.type && 0 < t.addedNodes.length && !te(t.addedNodes[0]) && ($.searchPseudoElements && o(t.target), r(t.target)),
              'attributes' === t.type && t.target.parentNode && $.searchPseudoElements && o(t.target.parentNode),
    ...
    ge = {
      ...
      children: [
        pe,
        {
          ...
          children: [
            { tag: 'animate', attributes: Q({}, me, { attributeName: 'r', values: '28;14;28;28;14;28;' }) },
    ...
    return {
      ...
      icon: Array.isArray(a)
        ? {
            ...
            children: [
              { tag: 'path', attributes: { class: ''.concat($.familyPrefix, '-').concat(Y.SECONDARY), fill: 'currentColor', d: a[0] } },
              { tag: 'path', attributes: { class: ''.concat($.familyPrefix, '-').concat(Y.PRIMARY), fill: 'currentColor', d: a[1] } },
            ],
          }
  ...
  function ye(a, r) {
    return new vt(function (t, e) {
      ...
      'object' === i(g.FontAwesomeKitConfig) && 'string' == typeof window.FontAwesomeKitConfig.token && g.FontAwesomeKitConfig.token,
        a && r && !$.showMissingIcons ? e(new ue('Icon is missing for prefix '.concat(r, ' with icon name ').concat(a))) : t(n);
    });
  }
  var we = W.styles;
  function xe(t) {
              ...
              Object.keys(r).forEach(function (t) {
                (e.definitions[t] = Q({}, e.definitions[t] || {}, r[t])),
                  (function t(e, a) {
                    ...
                    'function' != typeof W.hooks.addPack || r ? (W.styles[e] = Q({}, W.styles[e] || {}, i)) : W.hooks.addPack(e, i),
                      'fas' === e && t('fa', a);
                  })(t, r[t]),
                  Bt();
              });
        ...
        if (t) {
          ...
          return Ee(Q({ type: 'icon' }, t), function () {
            return (
              ...
              $.autoA11y &&
                (u
                  ? (v['aria-labelledby'] = ''.concat($.replacementClass, '-title-').concat(m || kt()))
        ...
        return Ee({ type: 'text', content: t }, function () {
          return (
            ...
            Lt({
              ...
              transform: Q({}, yt, a),
              title: i,
              extra: { attributes: l, styles: u, classes: [''.concat($.familyPrefix, '-layers-text')].concat(d(c)) },
            })
          );
        });
      },
        ...
        return Ee({ type: 'counter', content: t }, function () {
          return (
            ...
            (function (t) {
              ...
              content: t.toString(),
              title: a,
              extra: { attributes: c, styles: l, classes: [''.concat($.familyPrefix, '-layers-counter')].concat(d(i)) },
            })
          );
        });
      },
